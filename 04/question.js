...
infoWrap.style.width = "350px";
infoWrap.style.height = "60px";
infoWrap.style.textAlign = "center";

leftArrow.innerHTML = "이전";
rightArrow.innerHTML = "다음";
indexInfo.innerHTML = "1/3";

indexInfo.style.width = "50px"
indexInfo.style.height = "50px";
indexInfo.style.display = "inline-block";

leftArrow.style.width = "48px";
leftArrow.style.height = "23px";
leftArrow.style.border = "1px solid black";
leftArrow.style.borderRadius = "5px";
leftArrow.style.display = "inline-block";

rightArrow.style.width = "48px";
rightArrow.style.height = "23px";
rightArrow.style.border = "1px solid black";
rightArrow.style.borderRadius = "5px";
rightArrow.style.display = "inline-block";

infoWrap.appendChild(leftArrow);
infoWrap.appendChild(indexInfo);
infoWrap.appendChild(rightArrow);

wrap.appendChild(infoWrap);

function showPhoto(event) {
  var totalPage = 0
  if (todayPhoto % listNum == 0) { totalPage = todayPhoto.length/listNum }
  else { totalPage = parseInt(odayPhoto.length/3) + 1 }
